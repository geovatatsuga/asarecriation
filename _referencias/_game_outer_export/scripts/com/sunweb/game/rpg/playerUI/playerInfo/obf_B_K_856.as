package com.sunweb.game.rpg.playerUI.playerInfo
{
   ...
   import playerUI.AniamlBoxUIMC;
   
   public class obf_B_K_856 extends AniamlBoxUIMC implements IIconItemUI
   {
      ...
      public function updataBaseAnimal(param1:AnimalInfo) : void
      {
         this.obf_7_D_4402();
         if(!param1)
         {
         ...
         this.animalImage = new obf_9_c_4534(_loc2_,null);
         this.animalImage.x = 0;
         animalPonit.addChild(this.animalImage);
         this.updataAttrAnimal(param1.animalAtr);
      }
      ...
      public function updataAttrAnimal(param1:AnimalAttributesInfo) : void
      {
         var _loc3_:IconItemSkill = null;
         if(!param1 || !GameContext.localPlayer.trainerFullInfo)
         {
            return;
         }
         GameContext.localPlayer.trainerFullInfo.animalAtr = param1;
         txtHp.text = param1.hp + "/" + param1.hpMax;
         obf_K_e_3075.obf_G_K_2049.setHp(param1.hp,param1.hpMax);
         ...
         txtSpeed.text = GameContext.localPlayer.fullInfo.attributes.walkSpeed + "";
         ...
         var _loc2_:int = 0;
         while(_loc2_ < param1.skillArray.length)
         {
            _loc3_ = IconItemSkill.getNewIconItem(param1.skillArray[_loc2_],1);
            if(_loc2_ < this.skillBar.length)
            {
               if(_loc3_)
               {
                  (this.skillBar[_loc2_] as IconItemBag).pushIconItem(_loc3_);
               }
            }
            _loc2_++;
         }
