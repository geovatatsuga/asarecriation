package com.sunweb.game.rpg.playerUI
{
   ...
   public class DepotBagUI extends DepotBagUIMC implements IWindow, IIconItemUI
   {
      ...
      {
         DiversityManager.setTextField(txtDeyTitle,"DepotUI","txtTitle");
      ...
      {
         GameContext.bagItemManager.sendSortBag(PlayerBagIndex.PLAYER_DEPOT);
      ...
      public function clickIconItemBag(param1:IconItemBag, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(param1.isLocked)
         {
            ButtonToItemManager.useBTIById("addDepotBag");
         }
      ...
      public function onDragInIconItem(param1:IconItemBag, param2:IconItem, param3:IconItemBag) : void
      {
         ...
         if(!_loc4_ || !JSONUtil.getBoolean(_loc4_,["canDepot"],true))
         {
         ...
         if(param3.parentIconUI == this)
         {
            if(GameContext.bagItemManager != null)
            {
               ...
               {
                  GameContext.bagItemManager.sendSplitItem(PlayerBagIndex.PLAYER_DEPOT,param3.itemIndex,param1.itemIndex,param2.itemCount);
               }
               else
               {
                  GameContext.bagItemManager.sendItemMove(param3.itemIndex,param1.itemIndex,PlayerBagIndex.PLAYER_DEPOT);
               }
            }
         }
         else if(param3.parentIconUI == obf_K_e_3075.playerBagUI)
         {
            GameContext.bagItemManager.sendItemMoveCrossBag(PlayerBagIndex.PLAYER_MAIN_BAG,param3.itemIndex,PlayerBagIndex.PLAYER_DEPOT,param1.itemIndex,this._npcId,this._funcMenuIndex);
         }
         else if(param3.parentIconUI == obf_K_e_3075.petBoxUI)
         {
            GameContext.bagItemManager.sendItemMoveCrossBag(PlayerBagIndex.PLAYER_PET_BAG,param3.itemIndex,PlayerBagIndex.PLAYER_DEPOT,param1.itemIndex,this._npcId,this._funcMenuIndex);
         }
         else
         {
            if(param3.parentIconUI != obf_K_e_3075.rideBoxUI)
            {
               param2.destroy();
               return;
            }
            GameContext.bagItemManager.sendItemMoveCrossBag(PlayerBagIndex.PLAYER_RIDE_BAG,param3.itemIndex,PlayerBagIndex.PLAYER_DEPOT,param1.itemIndex,this._npcId,this._funcMenuIndex);
         }
      }
      
      public function onDragOutIconItem(param1:IconItemBag, param2:IconItemBag, param3:IIconItemUI) : void
      {
         if(param2.parentIconUI == obf_K_e_3075.petBoxUI)
         {
            GameContext.bagItemManager.sendItemMoveCrossBag(PlayerBagIndex.PLAYER_DEPOT,param1.itemIndex,PlayerBagIndex.PLAYER_PET_BAG,param2.itemIndex,this._npcId,this._funcMenuIndex);
         }
         else if(param2.parentIconUI == obf_K_e_3075.rideBoxUI)
         {
            GameContext.bagItemManager.sendItemMoveCrossBag(PlayerBagIndex.PLAYER_DEPOT,param1.itemIndex,PlayerBagIndex.PLAYER_RIDE_BAG,param2.itemIndex,this._npcId,this._funcMenuIndex);
         }
      }
   }
}
