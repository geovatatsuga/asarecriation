package com.sunweb.game.rpg.playerUI.roulette
{
   ...
   public class obf_Y_s_2472 extends obf_0_7_g_595
   {
      ...
      public function obf_Y_s_2472(param1:int, param2:int, param3:int = 3)
      {
         super(param1,param2);
      ...
      {
         super.action(param1);
         if(param1 == obf_0_7_g_595.BEGINNING_STATUS)
         {
            this.currentBEActIndex = 0;
            _doTimeInv = new TimeLimiter(this.beginTimes[0]);
         }
         else if(param1 == obf_0_7_g_595.ENDING_STATUS)
         {
            this.currentBEActIndex = 0;
      ...
      override protected function obf_F_8_1754() : void
      {
         ...
         {
            obf_B_S_1600 = obf_0_7_g_595.RUNNING_STATUS;
         }
         else
         {
      ...
      override protected function obf_E_6_2765() : void
      {
         ...
         if(this.loopLimit <= 0)
         {
            ...
            {
               obf_B_S_1600 = obf_0_7_g_595.ENDING_STATUS;
               this.currentBEActIndex = 0;
            }
         }
      ...
      override protected function obf_z_x_915() : void
      {
         ...
         {
            obf_B_S_1600 = obf_0_7_g_595.DONE_STATUS;
