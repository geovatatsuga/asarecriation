package com.sunweb.game.rpg.playerUI.rideDepot
{
   ...
   import com.sunweb.game.rpg.rideDepot.RideDepotItemInfo;
   ...
   import playerUI.RideDepotUIMC;
   
   public class RideDepotUI extends RideDepotUIMC implements IIconItemUI
   {
      ...
      private var rideDepotConfig:Object;
      
      private var currentLv:int;
      
      public function RideDepotUI()
      {
         ...
         while(_loc1_ <= this.pageButtons.length)
         {
            ...
            while(_loc4_ < this.bagPageSize)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  _loc6_.addValidType(GameItemType.RIDE);
                  _loc3_.push(_loc6_);
         ...
         this.rideDepotConfig = obf_2_l_4040.getRideDepotConfig();
         this.setBagsPage(1);
      ...
      private function obf_x_v_2806() : void
      {
         ...
         obf_K_e_3075.addUIMouseToolTip(txtRemark2,"remarkRideWardrobe");
      }
      ...
      private function onUpLv(param1:Event) : void
      {
         ...
         if(!this.rideDepotConfig)
         {
            return;
         }
         var _loc2_:int = (JSONUtil.getInt(this.rideDepotConfig,["max"]) - JSONUtil.getInt(this.rideDepotConfig,["init"])) / 2;
         if(this.currentLv >= _loc2_ + 1)
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","maxLv"));
            return;
         }
         var _loc3_:Object = JSONUtil.getValue(this.rideDepotConfig,"upLevelItem");
         for(_loc4_ in _loc3_)
         {
            if(_loc3_[_loc4_] > obf_K_e_3075.playerBagUI.getItemCount(_loc4_))
            {
               obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","noStuf"));
               return;
            }
         }
         obf_2_l_4040.sendRideDepotUpLevelRequest();
      }
      ...
      private function obf_G_k_3294(param1:MouseEvent) : void
      {
         ...
         var _loc2_:Object = JSONUtil.getValue(this.rideDepotConfig,"upLevelItem");
         var _loc3_:GameTipUI = new GameTipUI("RideDepotUITip");
         var _loc4_:int = 150;
         var _loc5_:int = 0;
         for(_loc6_ in _loc2_)
         {
            ...
            _loc3_.addTipInfo(DiversityManager.getString("RideDepotUI","upLvCost",[_loc7_.name,_loc2_[_loc6_]]),_loc4_,_loc5_);
         }
      ...
      {
         GameTipManager.closeTip("RideDepotUITip");
      }
      ...
      private function setBagsPage(param1:int) : void
      {
      ...
      public function obf_k_T_4034(param1:RideDepotUpLevelAnswer) : void
      {
         txtIconBarNum.text = "";
         txtLv.text = "";
         this.currentLv = param1.currentLv;
         txtIconBarNum.text = DiversityManager.getString("RideDepotUI","txtIconBarNum",[param1.currentCount]);
         txtLv.text = DiversityManager.getString("RideDepotUI","txtLv",[param1.currentLv]);
      }
      
      public function onBagCheck(param1:Array) : void
      {
         var _loc2_:IconItemBag = null;
         var _loc3_:RideDepotItemInfo = null;
      ...
      public function clickIconItemBag(param1:IconItemBag, param2:Boolean, param3:Boolean) : void
      {
         ...
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","upLv"));
            return;
         }
      }
      ...
      public function dbclickIconItemBag(param1:IconItemBag) : void
      {
         ...
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","ridePrompt_BagIsFull"));
            return;
         }
         var _loc2_:int = this.allBags.indexOf(param1);
         obf_2_l_4040.sendRideDepotRemoveRequest(_loc2_,param1.haveIconItem.itemId);
      }
      ...
      public function onDragInIconItem(param1:IconItemBag, param2:IconItem, param3:IconItemBag) : void
      {
         ...
         if(!param1 || param3.parentIconUI != obf_K_e_3075.rideBoxUI)
         {
            return;
         }
         if(!this.haveEmptyBag(1))
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","bagFull"));
            return;
         }
         ...
         var _loc5_:GameItemFullInfo = obf_K_e_3075.playerFullInfoUI.getEquipRideInfo();
         if((Boolean(_loc5_)) && param2.itemId == _loc5_.itemId)
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","sommun"));
            return;
         }
         if(_loc4_.rank == GameItemRank.MAGIC || _loc4_.rank == GameItemRank.NOMAL)
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","NOMAL"));
            return;
         }
         if(GameItemManager.haveValidTime(param2.itemCode))
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","term"));
            return;
         }
         for each(_loc6_ in this.allBags)
         {
            if(Boolean(_loc6_.haveIconItem) && _loc6_.haveIconItem.itemCode == param2.itemCode)
            {
               obf_K_e_3075.showTipInfo(DiversityManager.getString("RideDepotUI","be"));
               return;
            }
         }
         obf_2_l_4040.sendRideDepotAddRequest(param2.itemId);
      }
      ...
      {
         DiversityManager.setTextField(cmdPage1.txtLabel,"RideDepotUI","cmdPage1",null,true);
         DiversityManager.setTextField(cmdPage2.txtLabel,"RideDepotUI","cmdPage2",null,true);
         DiversityManager.setTextField(cmdPage3.txtLabel,"RideDepotUI","cmdPage3",null,true);
         DiversityManager.setTextField(cmdPage4.txtLabel,"RideDepotUI","cmdPage4",null,true);
         DiversityManager.setTextField(txtDeyTitle,"RideDepotUI","txtDeyTitle");
         DiversityManager.setTextField(txtDayRideNum,"RideDepotUI","txtDayRideNum");
         DiversityManager.setTextField(txtRemark1,"RideDepotUI","txtRemark1");
         txtRemark2.htmlText = "<A HREF=\'event:#\'>" + DiversityManager.getString("RideDepotUI","txtRemark2") + "</a>";
         DiversityManager.setTextField(txtDayArr,"RideDepotUI","txtDayArr");
         cmdUpLv.label = DiversityManager.getString("RideDepotUI","cmdUpLv");
      }
