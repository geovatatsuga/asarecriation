package com.sunweb.game.rpg.playerUI.legend
{
   ...
   import playerUI.LegendUIMC;
   
   public class LegendUI extends LegendUIMC implements obf_z_A_3653, IIconItemUI
   {
      ...
      public function LegendUI()
      {
         ...
         this.obf_0_5_I_285[tabelUpgrade] = obf_K_e_3075.upgradeUI;
         this.obf_0_5_I_285[tableEnchase] = obf_K_e_3075.obf_8_C_1943;
         obf_K_e_3075.showChildUI(this,this.obf_0_5_I_285[tabelUpgrade]);
      ...
      {
         DiversityManager.setTextField(this.tabelUpgrade.txtLabel,"LegendUI","tabelUpgrade",null,true);
         DiversityManager.setTextField(this.tableEnchase.txtLabel,"LegendUI","tableEnchase",null,true);
         DiversityManager.setTextField(txtTitle,"LegendUI","txtTitle");
      }
      ...
      public function getGemLevelDisplay(param1:int = 0, param2:int = 0) : DisplayObject
      {
         var _loc3_:Sprite = new Sprite();
         var _loc4_:DisplayObject = ResourceManager.instance.getMovieClip("lg" + param1 + param2 + "@lgem");
         _loc4_.x = 15;
