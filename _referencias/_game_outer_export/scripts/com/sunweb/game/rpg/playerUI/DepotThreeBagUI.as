package com.sunweb.game.rpg.playerUI
{
   ...
   public class DepotThreeBagUI extends DepotBagUIMC implements IWindow, IIconItemUI
   {
      ...
      public function DepotThreeBagUI()
      {
      ...
      {
         GameContext.bagItemManager.sendSortBag(PlayerBagIndex.obf_G_r_1422);
      ...
      public function clickIconItemBag(param1:IconItemBag, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(param1.isLocked)
         {
            ButtonToItemManager.useBTIById("addDepotThreeBag");
         }
      ...
      public function onDragInIconItem(param1:IconItemBag, param2:IconItem, param3:IconItemBag) : void
      {
         ...
         if(param3.parentIconUI == this)
         {
            if(GameContext.bagItemManager != null)
            {
               ...
               {
                  GameContext.bagItemManager.sendSplitItem(PlayerBagIndex.obf_G_r_1422,param3.itemIndex,param1.itemIndex,param2.itemCount);
               }
               else
               {
                  GameContext.bagItemManager.sendItemMove(param3.itemIndex,param1.itemIndex,PlayerBagIndex.obf_G_r_1422);
               }
            }
         }
         else
         {
            ...
            GameContext.bagItemManager.sendItemMoveCrossBag(PlayerBagIndex.PLAYER_MAIN_BAG,param3.itemIndex,PlayerBagIndex.obf_G_r_1422,param1.itemIndex,this._npcId,this._funcMenuIndex);
         }
      }
      ...
      {
         DiversityManager.setTextField(txtDeyTitle,"DepotUI","txtThreeTitle");
