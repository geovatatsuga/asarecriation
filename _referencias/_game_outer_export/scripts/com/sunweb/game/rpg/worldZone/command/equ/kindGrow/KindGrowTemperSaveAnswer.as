package com.sunweb.game.rpg.worldZone.command.equ.kindGrow
{
   ...
   public class KindGrowTemperSaveAnswer extends obf_O_8_1034
   {
      
      public var info:EquipKindGrowInfo;
      
      public function KindGrowTemperSaveAnswer()
      {
         super(CommandCodePlayerEquipKindGrow.KIND_GROW_TEMPER_SAVE_ANSWER);
      }
