package com.sunweb.game.rpg.iconItem
{
   ...
   public class obf_n_m_2273 extends IconItem
   {
      
      public function obf_n_m_2273(param1:String, param2:String)
      {
         super(GameItemManager.getItemIcon(param1));
         itemCode = param1;
         itemId = param2;
         addType(GameItemType.obf_y_n_2092);
      }
      
      public static function getNewIconItem(param1:String, param2:String) : obf_n_m_2273
      {
         var _loc3_:Object = GameItemManager.getItemConfig(param1);
         if(!_loc3_)
         {
            obf_x_0_1295.obf_r_w_3556("obf___4888(" + param1 + ")obf___4949！");
            return null;
         }
         var _loc4_:obf_n_m_2273 = new obf_n_m_2273(param1,param2);
      ...
      public static function showTip(param1:String, param2:String) : void
      {
         ...
         var _loc7_:ItemPlayerDevilInfo = JSONUtil.getObject(_loc6_,["devilInfo"]) as ItemPlayerDevilInfo;
         if(_loc6_)
         {
            if(_loc7_)
            {
               _loc8_ = obf_0_4_6_372.getDevilFinalApt(_loc7_,_loc6_.itemCode);
      ...
      {
         var _loc2_:IconItemBag = obf_K_e_3075.playerDevilUI.getDevilBagById(itemId);
         if(!_loc2_ || !_loc2_.haveIconItem)
         {
            return false;
         }
         return GameContext.bagItemManager.sendUseItem(itemCode,PlayerBagIndex.obf_w_y_3760,_loc2_.itemIndex);
      }
   }
}
