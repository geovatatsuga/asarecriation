package obf_p_w_3235
{
   ...
   import playerUI.LockTowerInitUIMC;
   
   public class obf_U_4_1625 extends LockTowerInitUIMC implements IIconItemUI, IPlayerUI
   {
      ...
      {
         DiversityManager.setTextField(txtTitle,"lockTowerInitUI","txtTitle");
         DiversityManager.setTextField(txtTip1,"lockTowerInitUI","txtTip1");
         DiversityManager.setTextField(txtTip2,"lockTowerInitUI","txtTip2");
         cmdSure.label = DiversityManager.getString("lockTowerInitUI","cmdSure");
      }
      ...
      public function obf_H_Z_3613(param1:MouseEvent) : void
      {
         ...
         var _loc2_:String = obf_N_9_4230.obf_L_A_4035(this.iconBag.haveIconItem.itemCode);
         if(!_loc2_)
         {
            return;
         }
         if(obf_K_e_3075.lockTowerUI.hasMonster(_loc2_))
         {
            obf_K_e_3075.showTipInfo(DiversityManager.getString("lockTowerInitUI","hasMonster"));
            return;
         }
         obf_N_9_4230.obf_X_U_2834(this.obf_g_y_3934,this.iconBag.haveIconItem.itemCode,1);
