package obf_I_Q_4451
{
   ...
   import playerUI.SoulWeaponBoxUIMC;
   
   public class SoulWeaponBoxUI extends SoulWeaponBoxUIMC implements obf_z_A_3653, IIconItemUI
   {
      ...
      public function SoulWeaponBoxUI()
      {
         super();
         this.initDiversity();
         ...
         this.obf_0_5_I_285[cmdLevelUp] = obf_K_e_3075.soulLevelUpUI;
         this.obf_0_5_I_285[cmdUpgrade] = obf_K_e_3075.soulAssembleUI;
         this.obf_0_5_I_285[cmdEmbed] = obf_K_e_3075.soulEmbedUI;
         obf_K_e_3075.showChildUI(this,this.obf_0_5_I_285[cmdLevelUp]);
      ...
      private function onClickTableButton(param1:Event) : void
      {
      ...
      {
         DiversityManager.setTextField(txtDeyTitle,"SoulWeaponBoxUI","txtTitle");
         cmdLevelUp.txtLabel.text = DiversityManager.getString("SoulWeaponBoxUI","cmdSoulLevel");
         cmdUpgrade.txtLabel.text = DiversityManager.getString("SoulWeaponBoxUI","cmdSoulAssemble");
         cmdEmbed.txtLabel.text = DiversityManager.getString("SoulWeaponBoxUI","cmdSoulEmbed");
      }
      
      public function showUI() : void
      {
         var _loc1_:IPlayerUI = null;
         this.visible = true;
         for each(_loc1_ in this.obf_5_F_4317)
         {
            _loc1_.showUI();
         }
      }
