package obf_0_0_k_571
{
   ...
   public class obf_m_O_840 extends AdhocBoxUIMC implements IIconItemUI
   {
      ...
      public function obf_m_O_840()
      {
         ...
         var _loc2_:Object = _loc1_.activityAwards;
         if(!_loc2_)
         {
            return;
         }
         ...
         for(_loc4_ in _loc2_)
         {
            _loc5_ = new Object();
            _loc5_.code = _loc4_;
            _loc5_.pace = _loc2_[_loc4_];
            _loc3_.push(_loc5_);
         }
         this.showConvertVisualize(_loc3_,1);
      }
      ...
      public function initDiversity() : void
      {
         ...
         DiversityManager.setTextField(txtspTitle,"AstrictTimeUI","txtspTitle");
      }
      ...
      private function showConvertVisualize(param1:Array, param2:int = 1) : void
      {
         ...
         for each(_loc7_ in param1)
         {
            ...
            _loc9_ = IconItemManager.getIconItemByCode(_loc7_.code,"");
            if(_loc9_)
            {
               _loc10_ = GameItemManager.getItemConfig(_loc7_.code);
               ...
               if(Boolean(_loc8_._iconBag.haveIconItem) && Boolean(_loc10_))
               {
                  ...
                  if(_loc7_.pace > 0)
                  {
                     _loc8_.setNowMoney(_loc7_.pace);
                  }
               }
      ...
      private function onBuyItem(param1:Event) : void
      {
         ...
         var _loc3_:Object = GameItemManager.getItemConfig(_loc2_.code);
         if(!_loc3_)
         {
            return;
         }
         var _loc4_:int = int(_loc2_.pace);
         ...
         var _loc5_:SplitBoxUI = new SplitBoxUI(this.sendStoreBuyItem,[_loc3_.code],1,int(_loc3_.stackSize) || 1,SplitBoxUI.obf_x_x_1366,_loc4_);
         WindowManager.showWindow(_loc5_);
      }
      
      private function sendStoreBuyItem(param1:String, param2:int = 1) : void
      {
         if(GameContext.localPlayer.fullInfo.money < ShopManager.obf_8_q_3951)
         {
            WindowManager.showMessageBox(DiversityManager.getString("AstrictTimeUI","noMoney"));
            return;
         }
         activityBoxManager.sendBuyItem(param1,param2);
      }
      ...
      private function obf_0_2_B_370(param1:Event) : void
      {
         ...
         txtTime.htmlText = obf_l_y_733.getTimeStringMin(_loc6_.getTime() - _loc10_);
         if(txtTime.htmlText == DiversityManager.getString("TimePrompt","M",[0]))
         {
            obf_K_e_3075.closeUI(this);
         }
      }
