package obf_0_8_s_590
{
   ...
   public class FundUI extends FundUIMC implements IIconItemUI
   {
      
      private var bags:Array = new Array();
      
      public function FundUI()
      {
         super();
         this.visible = false;
      ...
      private function obf_2_Y_3019() : void
      {
         ...
         this.obf_7_E_4314(obf_g_0_3344.isbuyFund);
      }
      ...
      public function obf_B_v_1525() : void
      {
         ...
         this.bags = new Array();
         var _loc6_:Array = obf_g_0_3344.getFundList();
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_.length)
         {
            _loc2_ = new SmallGetBoxUI(this,1,_loc6_[_loc7_],true);
      ...
      public function initDiversity() : void
      {
         ...
         txtRemark.htmlText = JSONUtil.getStr(obf_g_0_3344.getOpenFund(),["explanation"]);
      }
