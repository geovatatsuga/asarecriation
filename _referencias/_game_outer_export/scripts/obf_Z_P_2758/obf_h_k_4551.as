package obf_Z_P_2758
{
   ...
   public class obf_h_k_4551 extends FateAwardCursorBase
   {
      ...
      public function obf_h_k_4551(param1:int, param2:int, param3:int, param4:int = 3)
      {
         super(param1,param2,param3);
         this.runLoopToTarget = param4;
         this.loopLimit = this.runLoopToTarget;
         this.endTimes = new Array();
         var _loc5_:int = 1 + Math.random() * 3;
         var _loc6_:int = 200;
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_)
         {
            this.endTimes.push(_loc6_);
            _loc6_ += _loc6_ * 0.4;
            _loc7_++;
         }
      }
      ...
      {
         super.action(param1);
         if(param1 == FateAwardCursorBase.BEGINNING_STATUS)
         {
            this.currentBEActIndex = 0;
            _doTimeInv = new TimeLimiter(this.beginTimes[0]);
         }
         else if(param1 == FateAwardCursorBase.ENDING_STATUS)
         {
            this.currentBEActIndex = 0;
      ...
      override protected function obf_F_8_1754() : void
      {
         ...
         {
            obf_B_S_1600 = FateAwardCursorBase.RUNNING_STATUS;
         }
         else
         {
      ...
      override protected function obf_E_6_2765() : void
      {
         ...
         if(this.loopLimit <= 0)
         {
            ...
            {
               obf_B_S_1600 = FateAwardCursorBase.ENDING_STATUS;
               this.currentBEActIndex = 0;
            }
         }
      ...
      override protected function obf_z_x_915() : void
      {
         ...
         {
            obf_B_S_1600 = FateAwardCursorBase.DONE_STATUS;
