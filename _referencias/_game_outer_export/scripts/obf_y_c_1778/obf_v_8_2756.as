package obf_y_c_1778
{
   ...
   import playerUI.RemoteViewBoxUIMC;
   
   public class obf_v_8_2756 extends RemoteViewBoxUIMC implements IIconItemUI, obf_z_A_3653
   {
      ...
      public function obf_v_8_2756()
      {
         super();
         this.initDiversity();
         this.visible = false;
         txtRemoteName.mouseEnabled = false;
         titleBox.mouseEnabled = false;
         this.obf_5_F_4317 = new Array();
         this.x = GameContext.gameStage.stageWidth / 2;
         this.y = GameContext.gameStage.stageHeight / 2;
         this.obf_0_5_I_285 = new Dictionary();
         this.obf_0_5_I_285[obf_0_b_772] = obf_K_e_3075.obf_G_u_2663;
         this.obf_0_5_I_285[obf_0_4_B_173] = obf_K_e_3075.obf_P_c_3266;
      ...
      public function setNoAnimalUI(param1:Boolean = true) : void
      {
         if(param1)
         {
            obf_0_4_B_173.visible = obf_0_b_772.visible = false;
         }
         else
         {
            obf_0_4_B_173.visible = obf_0_b_772.visible = true;
         }
      }
